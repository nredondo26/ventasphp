                        ...
                        <tr>
                          ...
                          <td style="width: 50%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="number" class="form-control" min="0" id="nuevoImpuestoVenta" name="nuevoImpuestoVenta" value="0">
                  ...
                  <div class="col-xs-6" style="padding-right:0px">
                     ...
                     <div class="input-group">
                      ...
                      <select class="form-control" id="nuevoMetodoPago" name="nuevoMetodoPago" required>
                        ...
                        <option value="tarjetaCredito">Nequi</option>
                        <option value="tarjetaDebito">Daviplata</option>                  
                      </select>    
